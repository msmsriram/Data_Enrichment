...
for filename in os.listdir(directory):
    if filename.endswith(".html"):
        ...
        # Load and split data
        loader = BSHTMLLoader(filepath, bs_kwargs={"features": "html.parser"},open_encoding='utf-8')
        data = loader.load()
...
# text_splitter = CharacterTextSplitter.from_tiktoken_encoder(chunk_size=4000, chunk_overlap=200)
